...
class MSDAGenerator : public KernelGenerator {
public:
    MSDAGenerator() : KernelGenerator("cm_msda_vlen") {}
...
protected:
    ...
    [[nodiscard]] JitConstants get_jit_constants(const RuntimeParams& params) const override {
        ...
        // std::cout << "----------------- MSDA::get_jit_constants -----------------" << std::endl;
    ...
    [[nodiscard]] Arguments get_arguments_desc(const RuntimeParams& params) const override {
        ...
        // std::cout << "----------------- MSDA::get_arguments_desc -----------------" << std::endl;
    ...
    [[nodiscard]] DispatchDataFunc get_dispatch_data_func() const override {
        return DispatchDataFunc{[](const RuntimeParams& params, KernelData& kd, ImplRuntimeParams* rt_params) {
            ...
            // // std::cout << "----------------- MSDA::get_dispatch_data_func -----------------" << std::endl;
            // // std::cout << "----------------- output_transpose_order: " << desc->output_transpose_order <<
            ...
            // auto& instance = reinterpret_cast<typed_primitive_inst<cldnn::msda>&>(*rt_params->instance);
            // const auto& cu_seqlens = msda_inst::get_mask_seqlens_from_memory2(instance.cu_seqlens_memory_ptr(), params.get_stream());
            ...
            // //  ", wg_count=" << wg_count << ", max_seq_len=" << max_seq_len << ", need_wg_mapping=" << need_wg_mapping << ", num_q_heads" << num_q_heads <<
            // //  std::endl;
...
class MSDAOptImpl : public PrimitiveImplCM {
public:
    DECLARE_OBJECT_TYPE_SERIALIZATION(ov::intel_gpu::cm::MSDAOptImpl)

    Stage::Ptr msda = make_stage<MSDAGenerator>();
...
BIND_BINARY_BUFFER_WITH_TYPE(ov::intel_gpu::cm::MSDAOptImpl)