...
// msda_params
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
struct msda_params : public base_params {
    msda_params() : base_params(KernelType::ACTIVATION) {}
    ...
    msda_configuration conf;
    bool should_use_msda_opt = false;
...
// MSDAKernelBase
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class MSDAKernelBase : public KernelBaseOpenCL {
public:
    using KernelBaseOpenCL::KernelBaseOpenCL;
    virtual ~MSDAKernelBase() {}

    struct DispatchData : public CommonDispatchData {};

protected:
    bool Validate(const Params& p) const override;
    JitConstants GetJitConstants(const msda_params& params) const;
};
}  // namespace kernel_selector
